...
import { buildFields } from './fields.js?v=3';
import { generateContours } from './contours.js?v=3';
import { generateHatching } from './hatching.js?v=3';
import { toImageData } from './loader.js?v=3';
import { totalPoints, totalLength } from './stroke.js?v=3';
